Feature: Test API endpoint - POST /v3/user-on-board/insert-user-client-workqueue
  #API 93: GET / v3/user-on-board/insert-user-client-workqueue
  ...
  Scenario: Positive Flow
    ...
    * def encryptedBody = crypto.encrypt(requestBodyStr)
    ...
    Given path '/admin-service/v3/user-on-board/insert-user-client-workqueue'
