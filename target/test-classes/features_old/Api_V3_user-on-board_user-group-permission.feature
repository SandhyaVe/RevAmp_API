Feature: Test API endpoint - POST /v3/user-on-board/user-group-permission
  ...
  Scenario: Positive Flow
    ...
    * match decryptedResponse.message == '#regex User group and custom permissions have been inserted successfully\\.'
